...
/// @nodoc
abstract class _$$_HoroscopeResponseModelCopyWith<$Res>
    implements $HoroscopeResponseModelCopyWith<$Res> {
  factory _$$_HoroscopeResponseModelCopyWith(_$_HoroscopeResponseModel value,
          $Res Function(_$_HoroscopeResponseModel) then) =
      __$$_HoroscopeResponseModelCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({String status, int code, String message, HoroscopeModel? data});
...
/// @nodoc
class __$$_HoroscopeResponseModelCopyWithImpl<$Res>
    extends _$HoroscopeResponseModelCopyWithImpl<$Res,
        _$_HoroscopeResponseModel>
    implements _$$_HoroscopeResponseModelCopyWith<$Res> {
  __$$_HoroscopeResponseModelCopyWithImpl(_$_HoroscopeResponseModel _value,
      $Res Function(_$_HoroscopeResponseModel) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_HoroscopeResponseModel(
      status: null == status
          ? _value.status
          : status // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$_HoroscopeResponseModel implements _HoroscopeResponseModel {
  _$_HoroscopeResponseModel(
  ...
  factory _$_HoroscopeResponseModel.fromJson(Map<String, dynamic> json) =>
      _$$_HoroscopeResponseModelFromJson(json);
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_HoroscopeResponseModel &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_HoroscopeResponseModelCopyWith<_$_HoroscopeResponseModel> get copyWith =>
      __$$_HoroscopeResponseModelCopyWithImpl<_$_HoroscopeResponseModel>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_HoroscopeResponseModelToJson(
      this,
    );
  }
}
...
abstract class _HoroscopeResponseModel implements HoroscopeResponseModel {
  factory _HoroscopeResponseModel(
      ...
      final HoroscopeModel? data}) = _$_HoroscopeResponseModel;

  factory _HoroscopeResponseModel.fromJson(Map<String, dynamic> json) =
      _$_HoroscopeResponseModel.fromJson;
