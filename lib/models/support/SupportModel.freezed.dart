...
mixin _$SupportModel {
  ...
  String? get ad_socket => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      socket: freezed == socket
          ...
          : socket // ignore: cast_nullable_to_non_nullable
              as String?,
      ad_socket: freezed == ad_socket
          ? _value.ad_socket
          : ad_socket // ignore: cast_nullable_to_non_nullable
              as String?,
...
class _$SupportModelImpl implements _SupportModel {
  ...
  @override
  String toString() {
    return 'SupportModel(id: $id, type: $type, reason: $reason, user_id: $user_id, astro_id: $astro_id, admin_id: $admin_id, socket: $socket, ad_socket: $ad_socket, rating: $rating, review: $review, reviewed_at: $reviewed_at, created_at: $created_at, updated_at: $updated_at, status: $status, message: $message, sender: $sender, sent_at: $sent_at)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.ad_socket, ad_socket) ||
                other.ad_socket == ad_socket) &&
