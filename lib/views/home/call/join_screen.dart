...
import 'package:astro_guide/views/home/call/one_to_one_meeting_screen.dart';
import 'package:astro_guide/views/home/call/utils/api.dart';
import 'package:astro_guide/views/home/call/utils/spacer.dart';
import 'package:astro_guide/views/home/call/utils/toast.dart';
import 'package:astro_guide/views/home/call/widgets/common/joining_details/joining_details.dart';
...
class _JoinScreenState extends State<JoinScreen> {
  ...
  Future<void> createAndJoinMeeting(callType, displayName) async {
    final token = await fetchToken();
    print(token);
    var _meetingID = await createMeeting(token);
    try {
        Navigator.push(
          context,
          MaterialPageRoute(
      ...
      showSnackBarMessage(message: "Create and Join Meeting", context: context);
    }
  }
